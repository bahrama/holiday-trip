...
a persistence unit "holidaytripPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "holidaytrip/pom.xml":
...
artifacts ("holidaytrip-ejb.jar" and "holidaytrip-web.war") are already built. You can build
